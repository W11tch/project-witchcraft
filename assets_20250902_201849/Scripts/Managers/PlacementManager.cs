...
using System.Collections; // **NEW:** Added for IEnumerator

namespace ProjectWitchcraft.Managers
{
    public class PlacementManager : Singleton<PlacementManager>
    {
        // ... (All header variables and Awake/OnEnable/OnDisable methods are the same) ...
        [Header("Dependencies")]
        ...
        private void HandlePlaceAction(PlaceActionTriggeredEvent e)
        {
            ...
            if (IsPlacementValid(finalPosition, _previewObject.Size))
            {
                ...
                // **FIX**: Copy the visual rotation state from the preview object to the final placed object.
