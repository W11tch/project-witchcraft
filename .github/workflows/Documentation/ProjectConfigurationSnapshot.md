...
| Layer | Collides With |
|---|---|
| `Default` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `TransparentFX` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `Ignore Raycast` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `Water` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `UI` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `BuildingBlocks` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
| `Ground` | `Default`, `TransparentFX`, `Ignore Raycast`, `Water`, `UI`, `BuildingBlocks`, `Ground` |
