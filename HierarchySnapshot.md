...
**Generated on:** 15/09/2025 17:44:09
---
...
- **Script:** `PlayerMovement`
    - **Reference:** `_moveSpeedStat` -> `ScriptableObject: MoveSpeed`
- **Script:** `PlayerController`
- **Script:** `CharacterStats`
    - **List Reference:** `baseStats` -> `ScriptableObject: MoveSpeed`
    - **List Reference:** `baseStats` -> `ScriptableObject: Damage`
    - **List Reference:** `baseStats` -> `ScriptableObject: Health`
    - **List Reference:** `baseStats` -> `ScriptableObject: AttackSpeed`
...
- **Script:** `Image`
- **Script:** `InventoryUI`
    - **Reference:** `characterInfoPanel` -> `GameObject: CharacterInfoPanel`
**Children: (2 total)**
#### InventoryGrid
- **Tag:** `Untagged`
- **Layer:** `UI`
...
- **Component:** `CanvasRenderer`
- **Script:** `Image`
- **Script:** `UI_StatsPanel`
    - **Reference:** `statDatabase` -> `ScriptableObject: StatDatabase`
    - **Reference:** `statDisplayPrefab` -> `GameObject: UI_StatDisplay_Prefab`
**Children: (1 total)**
###### StatsContainer
- **Tag:** `Untagged`
- **Layer:** `UI`
